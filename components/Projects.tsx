...
export default function Projects() {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      desc: "Astro Debunker is an AI integrated web application.",
      longDesc: "Astro Debunker is a full-stack web application that analyzes astrology predictions and explains them using scientific reasoning and psychology.",
      img: "/astrode.png",
      tech: ["Java", "Servlets", "JSP", "Hibernate", "Tailwind"],
      repo: "https://github.com/AmiwithA29/Astro-Debunker"
    }
  ]

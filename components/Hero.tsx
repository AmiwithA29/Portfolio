...
export default function Hero() {
  ...
  return (
    ...
    >
        ...
        <div className="mt-7">
          <p className="inline-block text-zinc-500 dark:text-zinc-400 text-sm md:text-lg font-mono tracking-tight bg-foreground/[0.04] dark:bg-white/[0.04] px-8 py-2.5 rounded-full border border-foreground/10 backdrop-blur-md transition-colors">
            I am a <span className="text-foreground font-bold italic">
              <Typewriter words={["Web Developer", "DSA Enthusiast", "Software Engineer"]} loop cursor cursorStyle="_" />
            </span>
          </p>
        </div>
      </motion.div>
      ...
      >
        <a href="https://github.com/AmiwithA29" target="_blank" className="hover:text-purple-600 transition-all duration-300 transform hover:scale-125"><FaGithub /></a>
        <a href="https://www.linkedin.com/in/sneha-kumari-293a81368/" target="_blank" className="hover:text-blue-600 transition-all duration-300 transform hover:scale-125"><FaLinkedin /></a>
      </motion.div>
      ...
      >
        {[
          { label: "Download Resume", icon: <FaPaperPlane />, link: "/Sneharesume.pdf", download: true },
